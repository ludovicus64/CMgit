<?php
class configurateurmousseCoussinsModuleFrontController extends ModuleFrontController   {
 
	public function initContent()
    {
    	parent::initContent();
    	$this->setTemplate('coussins.tpl');
    	...
    	if(isset($_POST["validation_dimensions"])){
    		...
    		if($forme=="carre"){//On enregistre dans le cookie la valeur de la largeur/densite
    			$this->context->cookie->__set('largeur' , $_POST["largeur"]);
    			$this->context->cookie->__set('densite' , $_POST["choix_densite"]);
    		}
    		
    		if($forme=="rectangle"){//On enregistre dans le cookie la valeur de la largeur/longueur/densite
    			$this->context->cookie->__set('largeur' , $_POST["largeur"]);
    		...
    		if($forme=="rond"){//On enregistre dans le cookie la valeur du diametre/densite
			...
			if ($results = Db::getInstance()->ExecuteS($sql)){
        		$this->context->smarty->assign('garnissages',$results);
    		}
    	}
